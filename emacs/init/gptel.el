...
(define-key global-map (kbd "§ g c") #'gptel)
(define-key global-map (kbd "§ g g") #'gptel-menu)
(define-key global-map (kbd "§ g a") #'gptel-add)
(define-key global-map (kbd "§ g f") #'gptel-add-file)
(define-key global-map (kbd "§ g i") #'gptel-inline)
(define-key global-map (kbd "§ g p") #'gptel-proofread)
